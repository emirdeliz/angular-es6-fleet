...
class RegisterUtil {
    ...
    static init(appName, inject) {
        this.app = angular.module(appName, inject);
        return this;
    }

    static directive (name, constructorFn) {
    ...
    static controller (name, contructorFn) {
        this.app.controller(name, contructorFn);
        return this;
    }

    static service (name, contructorFn) {
        this.app.service(name, contructorFn);
        return this;
    }

    static provider (name, constructorFn) {
        this.app.provider(name, constructorFn);
        return this;
    }

    static factory (name, constructorFn) {
        constructorFn = this._normalizeConstructor(constructorFn);
        var factoryArray = this._createFactoryArray(constructorFn);
    ...
    static config (name, constructorFn) {
        this.app.config(name, constructorFn);
        return this;
    }
